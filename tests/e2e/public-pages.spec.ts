...
test.describe("public pages", () => {
  ...
  test("tours listing shows no pricing and lets you filter by group size and arrival month", async ({ page }) => {
    await page.goto("/tours");
  ...
  test("package detail page renders", async ({ page }) => {
    ...
    await expect(page.getByRole("button", { name: "Request This Trip" })).toBeVisible();
  });
